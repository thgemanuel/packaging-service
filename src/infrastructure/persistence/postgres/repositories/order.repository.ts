...
import { OrderRepository, ORDER_REPOSITORY_NAME } from '@domain/repositories/order.repository';
...
export class OrderRepositoryTypeORM implements OrderRepository {
  ...
  async findByOrderId(orderId: string): Promise<Order | null> {
    ...
    return orderSchema ? this.orderMapper.fromSchemaToEntity(orderSchema, true) : null;
  }
